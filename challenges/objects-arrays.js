...
largerPopulation = zooAnimals.filter(word => word.population <5);
...
populationTotal = zooAnimals.reduce((total,current) => total + current.population,0);
